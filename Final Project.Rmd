...
# One-hot: type, source, rating (justification: limited entries)
# anime_data_encoded <- anime_data |>
#   dummy_cols(select_columns = c("type", "source", "rating"), 
#              remove_selected_columns = TRUE, 
#              ignore_na = TRUE)

# Multi-hot: genre, animation
